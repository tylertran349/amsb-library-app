                    ...
                    <div class="book-card">
                        <div class="book-details">
                            ...
                            <div class="book-text-content">
                                ...
                                <div class="book-meta">
                                    <p class="book-info"><strong>Author:</strong> <?= esc($book['author']) ?></p>
                                    <p class="book-info"><strong>Genre:</strong> <?= esc($book['genre']) ?></p>
                                    <p class="book-info"><strong>Publication year:</strong> <?= esc($book['publication_year']) ?></p>
                                </div>
                            </div>
                        </div>
